...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    def get_subscription_info(self, obj):
        """Background information about the subscription"""
        if obj.subscription:
            return {
...
class RefundSerializer(serializers.ModelSerializer):
    ...
    def get_payment_info(self, obj):
        """Background information about the payment"""
        return {
            "id": obj.payment.id,
    ...
    def get_created_by_info(self, obj):
        """Background information about who created the refund"""
        if obj.created_by:
...
class StripeCheckoutSessionSerializer(serializers.Serializer):
    """Serializer for Stripe Checkout Session response"""
