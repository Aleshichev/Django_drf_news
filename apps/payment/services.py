...
class StripeService:
    ...
    def create_checkout_session(
        ...
        """Create session in Stripe Checkout"""
        try:
            # get and create customer 
                ...
                line_items=[
                    {
                        "price_data": {
                            ...
                            "unit_amount": int(payment.amount * 100),  # Per cents
                        },
                        "quantity": 1,
                    }
                ],
...
class PaymentService:
    ...
    def create_subscription_payment(
        ...
        """Creates payment and subscription"""
        # Create subscription
        subscription = Subscription.objects.create(
            ...
            end_date=timezone.now(),  # Will be updated upon activation
        )
...
class WebhookService:
    """Service to process webhook events"""
    ...
    def process_stripe_webhook(event_data: Dict) -> bool:
        ...
        try:
            ...
            if event_type == "checkout.session.completed":
                ...
                # Unnown event type mark as ignored
    ...
    def _handle_checkout_completed(event_data: Dict) -> bool:
        """Processes end checkout session"""
        try:
    ...
    def _handle_dispute_created(event_data: Dict) -> bool:
        """Handles created dispute"""
        try:
            dispute = event_data["data"]["object"]
            charge_id = dispute.get("charge")

            # Here you can implement logic to notify admins or take other actions
            # For example, log the dispute or send an email
