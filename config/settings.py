...
# Additional locations of static files (if directory exists)
STATICFILES_DIRS = []

# Check if 'static' directory exists in BASE_DIR
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # port for Vite dev server
    "http://127.0.0.1:5173",
    "https://domen.com",
    "https://www.domen.com",
]
...
# Email settings (for production, use SMTP backend)
