...
class PaymentAdmin(admin.ModelAdmin):
    ...
    def amount_display(self, obj):
        """Sum display with currency"""
        return f"${obj.amount} {obj.currency}"

    amount_display.short_description = "Amount"

    def status_display(self, obj):
        """Visual status display with color"""
        colors = {
            "succeeded": "green",
            "failed": "red",
            "pending": "orange",
...
class RefundAdmin(admin.ModelAdmin):
    ...
    def is_partial_display(self, obj):
        """Visual display of partial/full refund"""
        if obj.is_partial:
...
class WebhookEventAdmin(admin.ModelAdmin):
    ...
    def retry_failed_events(self, request, queryset):
        """Retries processing of failed events"""
