...
class Payment(models.Model):
    ...
    @property
    def is_pending(self):
        """Checks if the payment is pending or processing"""
...
class PaymentAttempt(models.Model):
    """Trying to process a payment attempt"""
...
class Refund(models.Model):
    ...
    @property
    def is_partial(self):
        """Checks if the refund is partial"""
...
class WebhookEvent(models.Model):
    """ webhook events from payment providers like Stripe"""
    PROVIDER_CHOICES = [
        ('stripe', 'Stripe'),
        ('paypal', 'PayPal'),
    ]
